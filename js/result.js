...
Kakao.init('3e8542aaf81a72e73112cb9a6fe5d737');
...
function sendLink() {
    ...
    Kakao.Link.sendDefault({
        ...
        imageUrl: 'https://mbit.weniv.co.kr/stactic/img/mbit_thumbnail.png',
        link: {
            mobileWebUrl: 'https://mbit.weniv.co.kr',
            androidExecutionParams: 'https://mbit.weniv.co.kr',
        },
        },
        social: {
        likeCount: 286,
